...
function copyInto(overwrite, dest) {
    ...
    try {
        ...
        console.error('Detect these cases here and use a fallback');
    }
    ...
    const Util = {
        ...
        extend: function (...args) {
            return copyInto.apply(this, [true].concat(args));
        },

        defaults: function (...args) {
              return copyInto.apply(this, [false].concat(args));
        },
        ...
        * Take an element, and break up all of its text content into unique pieces such that:
        ...
        splitByBlockElements: function (element) {
            ...
            var toRet = [],
                blockElementQuery = Util.blockContainerElementNames.join(',');
            ...
            for (var i = 0; i < element.childNodes.length; i++) {
                ...
                if (child.nodeType === 3) {
                    ...
                    if (blockElements.length === 0) {
                        ...
                        toRet = toRet.concat(Util.splitByBlockElements(child));
                    }
                }
            }
